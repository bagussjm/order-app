								...
								<div class="row">
                                    ...
                                    <?php else:?>
                                        ...
                                        <div class="col m6 l6">
                                            ...
                                            )?>" class="btn-flat waves-effect waves-light right blue-text"  style="margin: 12px 5px" title="buat surat perintah">
                                                <i class="mdi-action-print"></i>
                                            </a>
                                            <a href="#!" class="btn-flat right  orange-text waves-effect waves-orange" type="button" style="margin: 12px 5px" title="buat invoice">
