                ...
                <div class="card">
                    ...
                    <table class="bordered" id="pelanggan-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <a href="#restore-<?= $i['pelanggan_id']?>" class="btn-flat waves-effect waves-light col l6 modal-trigger" title="hapus data">
                            ...
                            <!-- Modal delete -->
                            <div id="restore-<?= $i['pelanggan_id']?>" class="modal">
                                <div class="modal-content">
                                    <h4 class="red-text text-lighten-1 ">
                                        <i class="mdi-action-info-outline"></i> pulihkan data pelanggan ?
                                    </h4>
                                    <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="<?= base_url('PelangganController/restore/'.$i['pelanggan_id'])?>" class="modal-close waves-effect waves-green btn green lighten-1">lanjutkan</a>
